...
class TestCollaborateForm(TestCase):
    def test_if_form_is_valid(self):
        collaborate_form = CollaborateForm({'name': "mustafa", 
                        'email': 'akbarimustafa64@gmail.com',
                        'message': 'this is a message of collaboration' })
        self.assertTrue(collaborate_form.is_valid(), msg="From is not valid")
